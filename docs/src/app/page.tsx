...
const NoSSR = dynamic(() => import("@/components/CodeDoc"), { ssr: false }); // Importa o componente somente no lado do cliente | CodeDoc.tsx
...
export default function Home() {
  return (
    <main className="mx-auto flex flex-col p-2 sm:p-4 md:p-8 lg:p-10 ">
      ...
      <NoSSR /> {/* Renderiza o componente somente no lado do cliente */}
      <p className="mb-4">
